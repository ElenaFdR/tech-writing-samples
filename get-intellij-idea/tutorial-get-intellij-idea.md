...
In this tutorial, you'll learn how to install IntelliJ IDEA Ultimate and access a 30 day free trial.
This tutorial is intended for novices.

It assumes you have basic knowledge of:

* navigating websites
* navigating your own computer
...
To install IntelliJ IDEA Ultimate, you will need:

* to know whether your computer has an Intel or Apple Silicon processor
* admin privileges on your computer to authorize the installation

## Downloading IntelliJ IDEA Ultimate

To get started, navigate to [the IntelliJ IDEA downloads page](https://www.jetbrains.com/idea/download/?section=mac) in your web browser.
...
4. Double click on the file you just downloaded. The current version (2025.2.4) is named 'ideaIU-2025.2.4.dmg'. This will change when a new version of IntelliJ IDEA Ultimate is released and the version number changes.
This will lead to a popup window appearing.
![IntelliJ IDEA installation popup](/images/screenshot-intellij-idea-disk-image-installation-popup.png)
...
9. Delete the download file ('ideaIU-2025.2.4.dmg' in this case).
You no longer need it.

10. Close the installation pop up with the IntelliJ IDEA and applications folder icons.
You no longer need it.
...
## Getting IntelliJ IDEA Ultimate ready to use

9. Read and accept the Jetbrains user agreement.
You will not be able to use IntelliJ IDEA without accepting this.

10. Read and accept or refuse the Data Sharing agreement.
...
12. Start a new project by double clicking on 'new project'.
...
It will automatically disappear when the plugin loading process is complete.
![Progress bar for loading free trial plugins](/images/screenshot-progress-bar-loading-plugins.png)
...
Follow the [Getting started with IntelliJ IDEA tutorial](https://www.jetbrains.com/guide/java/tutorials/getting-started-intellij-idea/) to:

* customize your IntelliJ IDEA environment
* learn how read, write or test code within IntelliJ IDEA
